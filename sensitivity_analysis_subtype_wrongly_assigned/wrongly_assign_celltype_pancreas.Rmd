...
```
```{r}
adata <- read_h5ad("../input/human_pancreas.h5ad")
...
write.csv(data.frame(closestSubtypes),"../configs/closest_subtypes_pancreas.csv")
...
dendro.plot
saveRDS(dendro.plot,"hclust_pancreas.rds")
...
```
```{r}
write_h5ad(adata,"../input/human_pancreas_subtype_wrongly_assigned.h5ad")
```
