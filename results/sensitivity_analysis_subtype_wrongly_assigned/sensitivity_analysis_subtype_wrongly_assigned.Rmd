...
```{r}
adata <- read_h5ad("../../input/immune_cell_hum_subtype_wrongly_assigned.h5ad")


table(adata$obs$final_annotation,adata$obs$CD8pos_T_cells_with_CD4pos_T_cells_final_annotation)
table(adata$obs$final_annotation,adata$obs$CD8pos_T_cells_with_CD4pos_T_cells_final_annotation)
